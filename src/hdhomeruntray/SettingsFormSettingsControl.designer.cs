...
namespace zuki.hdhomeruntray
{
	partial class SettingsFormSettingsControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_layoutpanel.Controls.Add(this.m_themelabel, 0, 3);
			this.m_layoutpanel.Controls.Add(this.m_trayiconhoverlabel, 0, 4);
			this.m_layoutpanel.Controls.Add(this.m_trayiconhoverdelaylabel, 0, 5);
			this.m_layoutpanel.Controls.Add(this.m_tunerstatuscolorsourcelabel, 0, 6);
			...
			this.m_layoutpanel.Controls.Add(this.m_theme, 1, 3);
			this.m_layoutpanel.Controls.Add(this.m_trayiconhover, 1, 4);
			this.m_layoutpanel.Controls.Add(this.m_trayiconhoverdelay, 1, 5);
			this.m_layoutpanel.Controls.Add(this.m_tunerstatuscolorsource, 1,6);
			...
			this.m_themelabel.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_themelabel.Font = new System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.m_themelabel.Location = new System.Drawing.Point(7, 105);
			this.m_themelabel.Name = "m_themelabel";
			this.m_themelabel.Size = new System.Drawing.Size(144, 34);
			this.m_themelabel.TabIndex = 3;
			...
			// m_theme
			// 
			this.m_theme.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_theme.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.m_theme.FormattingEnabled = true;
			this.m_theme.Location = new System.Drawing.Point(158, 109);
			this.m_theme.Margin = new System.Windows.Forms.Padding(4, 4, 4, 7);
			this.m_theme.Name = "m_trayiconhover";
			this.m_theme.Size = new System.Drawing.Size(131, 23);

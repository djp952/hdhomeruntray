...
namespace zuki.hdhomeruntray
{
	partial class PopupItemControl
	{
		...
		{
			this.m_layoutpanel = new zuki.hdhomeruntray.RoundedFlowLayoutPanel();
			this.SuspendLayout();
			// 
			// m_layoutpanel
			// 
			...
			this.m_layoutpanel.Padding = new System.Windows.Forms.Padding(6);
			this.m_layoutpanel.Radii = new zuki.hdhomeruntray.Radii(4, 4, 4, 4);
		...
		private zuki.hdhomeruntray.RoundedFlowLayoutPanel m_layoutpanel;
	}
}
